        ...
        <div className="col-span-2">
          ...
          <div className="max-w-md pb-10">
            <p className="text-beige">
              I enjoy volunteering my time to help others succeed. A project I co-founded and have been a part of over the past few years is <a href="https://fortwaynesoup.org" target="_blank" rel="nofollow noreferrer" className="text-blue hover:text-green transition-colors duration-700 ease-in">Fort Wayne SOUP</a>.
            </p>
          </div>
        </div>
        <div className="col-span-2">
          ...
          <div className="pt-10">
            ...
            <p className="text-beige max-w-lg mt-6">
              Using the resources available from Detroit SOUP, we scaffolded out what our version of SOUP would look like. I created the branding, logo, website, and marketing materials, and helped wrangle presenters. We quickly built a team of volunteers to help us grow the vision into reality.
            </p>
            <p className="text-beige max-w-lg mt-6">
